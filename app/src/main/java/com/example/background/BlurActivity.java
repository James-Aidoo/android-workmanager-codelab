...
public class BlurActivity extends AppCompatActivity {
    ...
    private void observeWorkInfo() {
        mViewModel.getOutputWorkInfo().observe(this, workInfoList -> {
            ...
            if (workInfo.getState().isFinished()) {
                ...
                String imageUri = outputData.getString(Constants.KEY_IMAGE_URI);
                if (!TextUtils.isEmpty(imageUri)) {
                    mViewModel.setOutputUri(imageUri);
    ...
    private void viewBlurredImage() {
        mOutputButton.setOnClickListener(view -> {
            Uri blurredImageUri = mViewModel.getOutputUri();
            if (blurredImageUri != null) {
                Intent actionView = new Intent(Intent.ACTION_VIEW, blurredImageUri);
